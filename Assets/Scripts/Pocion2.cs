...
public class Pocion2 : MonoBehaviour
{
    // Start is called before the first frame update.
    public CameraMovementController2 camaraposicion;
    ...
    private void Update()
    {
        ...
        {
            if(elemento1selec==true && elemento2selec==false && elemento3selec == true && elemento4selec == false && elemento5selec == true && elemento6selec == false
