...
public class Pocion6 : MonoBehaviour
{
    // Start is called before the first frame update
    public CameraMovementController6 camaraposicion;
    ...
    private void Update()
    {
        ...
        {
            if(elemento1selec==true && elemento2selec==false && elemento3selec == false && elemento4selec == false && elemento5selec == false && elemento6selec == true
                 && elemento7selec == true && elemento8selec == false && elemento9selec == false && elemento10selec == true)
            {
        ...
        if(hasGanado) {
            ...
            if (time >= 2)//al terminar pasan x segundos 
            {
                SceneManager.LoadScene(SceneManager.GetActiveScene().buildIndex - 6);
                Timer.currentTimer = 190;
                Cursor.visible = true;
            }
        }
    }
