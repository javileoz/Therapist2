...
public class Pocion1 : MonoBehaviour
{
    // Start is called before the first frame update
    public CameraMovementController camaraposicion;
    ...
    private void Update()
    {
        ...
        {
            if(elemento1selec==false && elemento2selec==true && elemento3selec == false && elemento4selec == true && elemento5selec == false && elemento6selec == false
                 && elemento7selec == false && elemento8selec == false && elemento9selec == false && elemento10selec == false)
            {
