...
public class Pocion5 : MonoBehaviour
{
    // Start is called before the first frame update
    public CameraMovementController5 camaraposicion;
    ...
    private void Update()
    {
        ...
        {
            if(elemento1selec==true && elemento2selec==true && elemento3selec == false && elemento4selec == true && elemento5selec == true && elemento6selec == true
                 && elemento7selec == false && elemento8selec == false && elemento9selec == true && elemento10selec == false)
            {
