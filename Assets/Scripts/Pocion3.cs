...
public class Pocion3 : MonoBehaviour
{
    // Start is called before the first frame update.
    public CameraMovementController3 camaraposicion;
    ...
    private void Update()
    {
        ...
        {
            if (elemento1selec == true && elemento2selec == true && elemento3selec == true && elemento4selec == true && elemento5selec == true && elemento6selec == true
                 && elemento7selec == false && elemento8selec == true && elemento9selec == false && elemento10selec == true)
            {
