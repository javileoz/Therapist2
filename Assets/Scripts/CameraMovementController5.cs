...
public class CameraMovementController5 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha4) && vistaEnfermedades==true)
        {
            elegirEnfCorrecta = true;
        }//Es incorrecto y pierde tiempo cuando le da a cualquier numero menos le correcto en este caso 3
        else if(Input.GetKeyDown(KeyCode.Alpha1) || Input.GetKeyDown(KeyCode.Alpha3) ||Input.GetKeyDown(KeyCode.Alpha9) || Input.GetKeyDown(KeyCode.Alpha5) 
